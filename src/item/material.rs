...
lazy_static! {
    ...
    pub static ref SAND_BLOCK: Material = Material::new(ID::Nothing, 99, true, "Sand Block");
    pub static ref CACTUS_BLOCK: Material = Material::new(ID::Nothing, 99, true, "Cactus Block");
    pub static ref ROSE: Material = Material::new(ID::Nothing, 99, true, "Rose");
    pub static ref TALL_GRASS: Material = Material::new(ID::Nothing, 99, true, "Tall Grass");
    pub static ref DEAD_SHRUB: Material = Material::new(ID::Nothing, 99, true, "Dead Shrub");
}

impl Material {
    fn new(id: ID, max_stack_size: i32, is_block: bool, name: &str) -> Self {
        Self {
            id,
            max_stack_size,
            is_block,
    ...
    pub fn to_material(id: BlockId) -> &'static Material {
        match id {
