...
impl ItemStack {
    ...
    pub fn add(&mut self, amount: i32) -> i32 {
        ...
        if self.num_in_stack > self.material.max_stack_size {
            let left_over = self.num_in_stack - self.material.max_stack_size;
            self.num_in_stack = self.material.max_stack_size;
            left_over
        } else {
            0
        }
    ...
    pub fn remove(&mut self) {
        ...
        if self.num_in_stack == 0 {
            self.material = &material::NOTHING;
        }
    }
